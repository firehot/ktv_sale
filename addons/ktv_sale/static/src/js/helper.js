...
openerp.ktv_sale.helper = function(erp_instance) {
	var helper = erp_instance.ktv_sale.helper = {
        ...
        all_room_actions : function(){
            ret = '.action_room_opens,.action_room_scheduled,.action_room_scheduled_cancel,.action_room_checkout,.action_room_reopen,.action_room_change,.action_room_merge,.action_room_buytime_continue,.action_room_buytime_refund,.action_room_buytime,.action_room_buyout';
            return ret;
        },
        //获取所有操作数组
        ...
        get_room_actions_list : function(r_state){
            ...
            //买钟:可换房 并房 续钟 退钟
            if(r_state == 'buytime')
                ret = '.action_room_change,.action_room_merge,.action_room_buytime_continue,.action_room_buytime_refund';
