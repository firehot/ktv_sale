...
class buyout_config(osv.osv):
    ...
    _columns.update({
            ...
            #买断时间限制
            "time_from": fields.float("time_from",required = True,help="买断起始时间" ),
            "time_to": fields.float("time_to",required = True,help="买断结束时间"),
            "test_datetime": fields.datetime("test_datetime"),
            #FIXME 截止时间,感觉多余,不使用
            "break_on": fields.float("break_on",help="该固定时长买断每天截止时间，即使买断未到点，截止时间一到也即刻结束"),
